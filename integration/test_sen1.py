...
class Sentinel1Test(TestCase):
    ...
    def test_open_datatree_sen1_grd(self):
        path = (
            ...
            "sample-data/tutorial_data/cpm_v253/S1A_IW_GRDH_1SDV_20240201T164915"
            "_20240201T164940_052368_065517_750E.zarr"
        )
    ...
    def test_open_datatree_sen1_slc(self):
        path = (
            "https://objectstore.eodc.eu:2222/e05ab01a9d56408d82ac32d69a5aae2a:"
            "sample-data/tutorial_data/cpm_v253/S1A_IW_SLC__1SDV_20231119T170635"
            "_20231119T170702_051289_063021_178F.zarr"
        )
        dt = xr.open_datatree(path, engine="eopf-zarr")
    ...
    def test_open_datatree_sen1_onc(self):
        path = (
            "https://objectstore.eodc.eu:2222/e05ab01a9d56408d82ac32d69a5aae2a:"
            "sample-data/tutorial_data/cpm_v253/S1A_IW_OCN__2SDV_20250224T054940_"
            "20250224T055005_058034_072A26_160E.zarr"
        )
        dt = xr.open_datatree(path, engine="eopf-zarr")
