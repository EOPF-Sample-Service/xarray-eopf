...
def flatten_to_dataset(
    ...
    for group_name, child_datatree in datatree.children.items():
        ...
        child_dataset = flatten_to_dataset(
            child_datatree,
            prefix=(
...
def flatten_to_dataset_dict(
    ...
    for name, child in datatree.children.items():
        ...
        datasets.update(flatten_to_dataset_dict(child, prefix=child_prefix, sep=sep))
    return datasets
